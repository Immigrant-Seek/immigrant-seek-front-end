    ...
    return (
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicFirm">
                ...
                <Form.Control name ="firm" type="text" placeholder="Enter the firm you work at currently" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicBio">
                <Form.Label>Biography</Form.Label>
                <Form.Control name ="bio" type="text" placeholder="Tell us a little about yourself" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicFile">
                <Form.Label>Profile Picture</Form.Label>
                <Form.Control name ="pfp" type="text" placeholder='Please submit a URL'/>
            </Form.Group>
