...
function LawyerProfile(){
    ...
    return (
        ...
        <button className="lawyer-back-btn" onClick={() => navigate('/Connect-with-a-Lawyer')}><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
